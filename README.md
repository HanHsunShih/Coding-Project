...
| ------------- | ------------- | ------------- | 
| [Image Generative Model<br> Using LoRA and DreamBooth](https://shorturl.at/dfvH1 )  | Machine Learning,<br> Image generation<br> using Stable Diffusion  | Using my drawings as a dataset to develop a Stable Diffusion<br> Checkpoint<br> model fine-tuned with LoRA and<br> DreamBooth  | 
